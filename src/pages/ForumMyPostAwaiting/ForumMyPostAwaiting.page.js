...
import styles from './ForumMyPostAwaiting.page.module.css';
import { NewForumPost } from '../../components/Modal/index';
import { openModal } from '../../components/Modal/Modal.action';
import { get_active_forums } from './ForumMyPostAwaiting.page.action';

import StudentForumSidebar from '../../components/StudentForumSidebar';


class ForumMyPostAwaiting extends React.Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(ForumMyPostAwaiting);