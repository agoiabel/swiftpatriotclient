...
import styles from './ForumMyPostDeclined.page.module.css';
import { NewForumPost } from '../../components/Modal/index';
import { openModal } from '../../components/Modal/Modal.action';
import { get_active_forums } from './ForumMyPostDeclined.page.action';
import StudentForumSidebar from '../../components/StudentForumSidebar';

class ForumMyPostDeclined extends React.Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(ForumMyPostDeclined);