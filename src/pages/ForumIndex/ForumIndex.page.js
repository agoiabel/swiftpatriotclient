...
import styles from './ForumIndex.page.module.css';
...
import { get_active_forums } from './ForumIndex.page.action';
...
const mapStateToProps = state => {
    return {
        forums: state.forumIndexReducer.forums,
        status: state.forumIndexReducer.status
    }
}
